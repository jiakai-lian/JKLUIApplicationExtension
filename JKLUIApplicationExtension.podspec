#
# Be sure to run `pod lib lint JKLUIApplicationExtension.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.resource_bundles = {
    'JKLUIApplicationExtension' => ['Pod/Assets/*.png']
  }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  # s.frameworks = 'UIKit', 'MapKit'
  s.dependency 'JKLThreadSafeMutableCollection', '0.1.1'
end
